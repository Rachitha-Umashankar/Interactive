...
<body>
    ...
    <div style="white-space: nowrap; overflow-x: auto; padding: 1rem;">
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="/static/img1.jpg" style="height: 500px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="/static/img2.jpg" style="height: 500px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="/static/img3.jpg" style="height: 500px;">
        </div>
        <div style="display: inline-block;" onclick="openModal(this)">
            <img src="/static/img4.jpg" style="height: 500px;">
        </div>
    </div>
...
![alt text](<Screenshot 2025-12-18 104244.png>)
## RESULT:
